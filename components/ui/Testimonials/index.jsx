   ...
   const testimonials = [
     {
       ...
       quote:
         "Techkareer helped me land my dream job at Google. Their platform made it easy to showcase my skills and projects, and I was able to connect with the right opportunities quickly.",
     },
     {
       ...
       quote:
         "As a data scientist, I found Techkareer's machine learning-powered matching algorithms to be incredibly accurate. I was able to find a role that perfectly aligned with my expertise.",
     },
     {
       ...
       quote:
         "Techkareer streamlined the job search process for me. I was able to showcase my full-stack projects and connect with top companies like Airbnb and Klarna in no time.",
     },
   ];
   return (
       ...
       <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
         <div className="max-w-xl sm:text-center md:mx-auto">
           ...
           <p className="mt-3 text-gray-600">
             Discover how Techkareer has helped tech professionals like you land
             their dream jobs at top companies.
           </p>
         </div>
         <div className="mt-12">
